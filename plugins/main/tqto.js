...
async function handler(m, { sock }) {
    ...
    const credits = [
        ...
        { name: 'Zann', role: 'Creator SCRAV BOT dan APK Stardem ScravBot', icon: '👨‍💻' },
        { name: 'SenzOkkotsu', role: 'Asisstant Developer', icon: '👨‍💻' },
        { name: 'Ell', role: 'Asisstant Developer', icon: '👨‍💻' },
        { name: 'Aqell', role: 'Developer SC BUG ScravBot Glitch', icon: '👨‍💻' },
    ...
    await sock.sendTable(m.chat, "ScravBot TEAM", headers, rows, m, { 
